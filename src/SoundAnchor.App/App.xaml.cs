...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        var dataDirectory = Value("--data-dir") ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), demo ? "SoundAnchor-Demo" : "SoundAnchor");
        ...
        {
            MessageBox.Show($"SoundAnchor could not start.\n\n{ex.Message}", "SoundAnchor", MessageBoxButton.OK, MessageBoxImage.Error);
            Shutdown(1);
        }
    }
